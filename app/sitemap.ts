...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/tools/ip-checker`,    lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE}/tools/cgnat-checker`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/tools/port-checker`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/tools/ipv6-checker`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
