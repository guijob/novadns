...
export function GroupsTable({ slug, groups: initialGroups, base, plan }: { slug: string; groups: GroupWithCount[]; base: string; plan: string }) {
  ...
  async function handleAdd(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = await addGroup(slug, new FormData(e.currentTarget))
